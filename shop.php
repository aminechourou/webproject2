...
$produitC=new ProduitC();
 $listeProduit=$produitC->recupererProduite();
 $listeProduit1=$produitC->recupererProduite();
 $r=0;
 $v=0;
 $b=0;
 $m=0;
 foreach($listeProduit1 as $ro)
 {
if($ro['couleur']=='rouge')
{
$r++;
...
<?php } ?></li>
           ...
           <div class="mb-4">
                ...
                <a href="shop1.php?couleur=rouge" class="d-flex color-item align-items-center" >
                  <span class="bg-danger color d-inline-block rounded-circle mr-2"></span> <span class="text-black">Rouge (<?php echo $r; ?>)</span>
                </a>
                <a href="shop1.php?couleur=vert" class="d-flex color-item align-items-center" >
                  <span class="bg-success color d-inline-block rounded-circle mr-2"></span> <span class="text-black">Vert (<?php echo $v; ?>)</span>
                </a>
                <a href="shop1.php?couleur=bleu" class="d-flex color-item align-items-center" >
                  <span class="bg-info color d-inline-block rounded-circle mr-2"></span> <span class="text-black">Bleu (<?php echo $b; ?>)</span>
                </a>
                <a href="shop1.php?couleur=mauve" class="d-flex color-item align-items-center" >
                  <span class="bg-primary color d-inline-block rounded-circle mr-2"></span> <span class="text-black">Mauve (<?php echo $m; ?>)</span>
                </a>
              </div>
    </header>
