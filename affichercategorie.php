      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Catégorie</h1>
            <a href="ajoutcate.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus-circle"></i> </i>Ajouter une catégorie</a></div>
          <!-- Content Row -->
          <!-- Content Row -->
          <div class="row">
            <!-- Area Chart -->
...
$listeLivraisons=$categorieC->afficherCategories();
...
foreach($listeLivraisons as $row){
  ...
  <td><?PHP echo $row['nomcat']; ?></td>
    <td> <br><div class="d-sm-flex align-items-center justify-content-between mb-4" ><a href="modifiercategorie.php?nomcat=<?PHP echo $row['nomcat']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-pen"></i> Modifier</a></td>
      <td> <br><div class="d-sm-flex align-items-center justify-content-between mb-4" ><a href="supprimercategorie.php?nomcat=<?PHP echo $row['nomcat']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-minus-circle"></i> Supprimer</a></td>
