      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="ajoutcat.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus-circle"></i> </i>Ajouter un produit</a></div>
          <!-- Content Row -->
          <!-- Content Row -->
          <div class="row">
            <!-- Area Chart -->
...
$listeLivraisons=$produitC->afficherProduits();
...
foreach($listeLivraisons as $row){
  ...
  <td><?PHP echo $row['nomcat1']; ?></td>
  <td><?PHP echo $row['date']; ?></td>
    <td><?PHP echo $row['type']; ?></td>
	<td><img width="100" height="100" src="images\<?php echo $row['image'] ;?>" ></td>
    <td> <br><div class="d-sm-flex align-items-center justify-content-between mb-4" ><a href="modifierproduit.php?ref=<?PHP echo $row['ref']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-pen"></i> Modifier</a></td>
      <td> <br><div class="d-sm-flex align-items-center justify-content-between mb-4" ><a href="supprimerproduit.php?ref=<?PHP echo $row['ref']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-minus-circle"></i> Supprimer</a></td>
