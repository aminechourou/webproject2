      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="ajoutcat1.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus-circle"></i> </i>Ajouter une catégorie</a></div>
          <!-- Content Row -->
          <!-- Content Row -->
          <div class="row">
            <!-- Area Chart -->
...
$listeLivraisons=$categorieC1->afficherCategories1();
...
foreach($listeLivraisons as $row){
	...
	<tbody>
	<tr>
  <td><?PHP echo $row['idcat1']; ?></td>
  <td><?PHP echo $row['nomcat1']; ?></td>
      <td> <br><div class="d-sm-flex align-items-center justify-content-between mb-4" ><a href="supprimercat1.php?nomcat1=<?PHP echo $row['nomcat1']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-minus-circle"></i> Supprimer</a></td>
