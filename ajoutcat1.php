                ...
                <div class="card-body">
                  <div class="card-body">
                    <div class="table-responsive">
                      <form method="get" action="ajoutercat1.php">
                        <table  width="60%" border="0px" cellspacing="0">
                            
                            <tr>
                            <td>Nom</td>
                              <td>
                                <input type="text" class="form-control form-control-user" width="30%" placeholder="donner un nom de catégorie"
                                  name="nomcat1" required>
                              </td>
                            </tr>
                            <tr>
                            <td></td>
